...
return [
    ...
    */
    ...
    'authenticator' => \Modules\Admin\Http\Authentication\Authenticators\AdminAuthenticator::class,
    ...
    */
    ...
    'transformer' => \Modules\Admin\Http\Transformers\AdminTransformer::class,
